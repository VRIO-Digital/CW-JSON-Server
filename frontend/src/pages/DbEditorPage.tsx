...
export default function DbEditorPage() {
  ...
  if (error) {
    return (
      <>
        <PageHeader
          title="Mock data"
          subtitle="Edit backend/db.json — the file every page in this app reads from."
        />
  ...
  return (
    <>
      <PageHeader
        title="Mock data"
        subtitle="Edit backend/db.json — the file every page in this app reads from. Saving writes to disk and takes effect immediately, with no restart."
        actions={
          <>
            <Button
              icon={<ReloadOutlined />}
